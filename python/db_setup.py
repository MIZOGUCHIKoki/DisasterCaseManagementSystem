...
def make_testData_person(conn: sqlite3.Connection) -> None:
    ...
    cur.executemany('''
        INSERT INTO person (id, group_id, age, allergy, remarks_food, remarks_other) VALUES (?, ?, ?, ?, ?, ?)
    ''', [
        ('c4ca4238a0b923820dcc509a6f75849b', 2, 25, 0, 'Peanut allergy', ''),
        ('c81e728d9d4c2f636f067f89cc14862c', 1, 30, 1, 'Gluten allergy, Prefers vegetarian', ''),
        ('eccbc87e4b5ce2fe28308fd9f2a7baf3', None, 22, 0, 'Lactose intolerance', 'Has pets'),
        ('a87ff679a2f3e71d9181a67b7542122c', 2, 28, 0, '', '')
    ])
    conn.commit()
...
def make_testData_serveLog(conn: sqlite3.Connection) -> None:
    cur: sqlite3.Cursor = conn.cursor()
    cur.executemany('''
        INSERT INTO serveLog (person_id, receiveClassID) VALUES (?, ?)
    ''', [
        ('c4ca4238a0b923820dcc509a6f75849b', 1),
        ('c4ca4238a0b923820dcc509a6f75849b', 1),
        ('c4ca4238a0b923820dcc509a6f75849b', 2),
        ('c81e728d9d4c2f636f067f89cc14862c', 3),
